            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                ...
                <form @submit.prevent="updateProfileInformation">
                    <div class="row justify-content-end m-5 mb-6 ">
                        ...
                        <select id="sort"  v-model="descending">
                            <option ></option>
                        ...
                        <button @submit.prevent="updateProfileInformation"
                                type="submit"
                                :class="{ 'opacity-25': form.processing ,'mx-4':true}" :disabled="form.processing">Клик</button>
                    </div>
                </form>
                ...
                <div class="grid grid-flow-col auto-rows-fr auto-cols-fr  grid-rows-4">
                    <div class="m-5" v-for="item in $page.props.ads.data" :key="item.id">
